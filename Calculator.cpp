...
/*Factorial function of the scien_calc class to return a long integer as the factorial of an acceptable number. This will convert the accepting number into an integer before calculating the factorial.*/
